...
var prevInfoWindow =false;    // declares a global varable prevInfoWindow to keep track of info windows to close when a new one is opened
  ...
  */
  function createMapMarker(placeData) {
    ...
    google.maps.event.addListener(marker, 'click', function() {
      // closes previous info window when opening a new one
      if(prevInfoWindow) {
